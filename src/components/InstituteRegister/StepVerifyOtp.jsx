...
const StepVerifyOtp = ({
  ...
  const { account, college, setCollege } = useInstituteContext();
  ...
  useEffect(() => {
    if (
      ...
      sendCollegeOtp({
        ...
        ups_colleges_id: college.collegeId,
      });
    }
  }, [mode, college?.collegeId, account?.onboardingUserId]);
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      if (mode === "college") {
        ...
        // 2️⃣ Fetch college data AFTER OTP
        ...
        setCollege((prev) => ({
          ...prev,
          otpVerified: true,
          collegeData: res?.data?.data || null,
        }));
      }
